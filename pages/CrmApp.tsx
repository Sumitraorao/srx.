...
import { 
  ...
  X, UserPlus, Briefcase, DollarSign
} from 'lucide-react';
...
const CrmApp = () => {
    ...
    const modules = ['Home', 'Leads', 'Contacts', 'Accounts', 'Deals', 'Tasks'];
        ...
        <div className="flex flex-col h-screen bg-[#f5f7f9] font-sans">
            ...
            <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0">
                ...
                <div className="flex items-center gap-3">
                    <button className="px-4 py-1.5 border border-gray-300 rounded text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                        Import
                    </button>
                    <button 
                        onClick={() => setIsCreateModalOpen(true)}
                        className="px-4 py-1.5 bg-brand-red text-white rounded text-sm font-bold hover:bg-brand-dark-red transition-colors flex items-center gap-2 shadow-sm"
                    >
                        <Plus size={16} /> Create {activeModule.slice(0, -1)}
                    </button>
                    <div className="flex items-center border border-gray-300 rounded overflow-hidden">
                        <button className="p-1.5 bg-gray-50 text-gray-600 border-r border-gray-300"><LayoutGrid size={16} /></button>
                        <button className="p-1.5 text-gray-400 hover:bg-gray-50"><BarChart3 size={16} /></button>
                    </div>
                </div>
            </div>
